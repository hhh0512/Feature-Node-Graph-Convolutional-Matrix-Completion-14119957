...
if TESTING:
    ...
    embeddings = sess.run(model.activations[-1], feed_dict=test_feed_dict)
    print("Embedding shape:", embeddings.shape)
    print("User 0 latent vector:", embeddings[0])
    print("User 1 latent vector:", embeddings[1])
    print("Item 0 latent vector:", embeddings[model.num_users])
    print("Item 1 latent vector:", embeddings[model.num_users + 1])
    ...
    for r in results[:10]:
        print(f"User {r['user']} has {len(r['recommendations'])} recommendations:")
